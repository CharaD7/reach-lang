...
data BaseEnvElem = BaseEnvElem
  { baseEnvName :: String
  , baseEnvVal :: SLVal
  , baseEnvCompletionKind :: Maybe String
  }

base_env_elems :: [BaseEnvElem]
base_env_elems =
    [ be ("makeEnum", SLV_Prim SLPrim_makeEnum, Just "Function")
    , be ("declassify", SLV_Prim SLPrim_declassify, Just "Function")
    , be ("commit", SLV_Prim SLPrim_commit, Just "Function")
    , be ("digest", SLV_Prim SLPrim_digest, Just "Function")
    , be ("transfer", SLV_Prim SLPrim_transfer, Just "Function")
    , be ("assert", SLV_Prim $ SLPrim_claim CT_Assert, Just "Function")
    , be ("assume", SLV_Prim $ SLPrim_claim $ CT_Assume False, Just "Function")
    , be ("require", SLV_Prim $ SLPrim_claim CT_Require, Just "Function")
    , be ("possible", SLV_Prim $ SLPrim_claim CT_Possible, Just "Function")
    , be ("check", SLV_Prim $ SLPrim_check, Just "Function")
    , be ("unknowable", SLV_Form $ SLForm_unknowable, Just "Function")
    , be ("balance", SLV_Prim $ SLPrim_balance, Just "Function")
    , be ("lastConsensusTime", SLV_Prim $ SLPrim_fluid_read_canWait FV_lastConsensusTime, Just "Function")
    , be ("baseWaitTime", SLV_Prim $ SLPrim_fluid_read_canWait FV_baseWaitTime, Just "Function")
    , be ("lastConsensusSecs", SLV_Prim $ SLPrim_fluid_read_canWait FV_lastConsensusSecs, Just "Function")
    , be ("baseWaitSecs", SLV_Prim $ SLPrim_fluid_read_canWait FV_baseWaitSecs, Just "Function")
    , be ("didPublish", SLV_Prim $ SLPrim_didPublish, Just "Function")
    , be ("Digest", SLV_Type ST_Digest, Just "TypeParameter")
    , be ("Null", SLV_Type ST_Null, Just "TypeParameter")
    , be ("Bool", SLV_Type ST_Bool, Just "TypeParameter")
    , be ("UInt", SLV_Type ST_UInt, Just "TypeParameter")
    , be ("Bytes", SLV_Prim SLPrim_Bytes, Just "TypeParameter")
    , be ("Contract", SLV_Type ST_Contract, Just "TypeParameter")
    , be ("Address", SLV_Type ST_Address, Just "TypeParameter")
    , be ("Token", SLV_Type ST_Token, Just "TypeParameter")
    , be ("forall", SLV_Prim SLPrim_forall, Just "Function")
    , be ("Data", SLV_Prim SLPrim_Data, Just "TypeParameter")
    , be ("Array", SLV_Prim SLPrim_Array, Just "TypeParameter")
    , be ("array", SLV_Prim SLPrim_array, Just "Function")
    , be ("Tuple", SLV_Prim SLPrim_Tuple, Just "TypeParameter")
    , be ("Object", SLV_Prim SLPrim_Object, Just "TypeParameter")
    , be ("Struct", SLV_Prim SLPrim_Struct, Just "TypeParameter")
    , be ("Foldable", SLV_Prim SLPrim_Foldable, Just "TypeParameter")
    , be ("Fun", SLV_Prim SLPrim_Fun, Just "TypeParameter")
    , be ("Refine", SLV_Prim SLPrim_Refine, Just "TypeParameter")
    , be ("exit", SLV_Prim SLPrim_exit, Just "Function")
    , be ("each", SLV_Form SLForm_each, Just "Method")
    , be ("intEq", SLV_Prim $ SLPrim_op PEQ, Just "Function")
    , be ("polyEq", SLV_Prim $ SLPrim_op PEQ, Just "Function")
    , be ("polyNeq", SLV_Prim $ SLPrim_polyNeq, Just "Function")
    , be ("digestEq", SLV_Prim $ SLPrim_op DIGEST_EQ, Just "Function")
    , be ("addressEq", SLV_Prim $ SLPrim_op ADDRESS_EQ, Just "Function")
    , be ("isType", SLV_Prim SLPrim_is_type, Just "Function")
    , be ("typeEq", SLV_Prim SLPrim_type_eq, Just "Function")
    , be ("typeOf", SLV_Prim SLPrim_typeOf, Just "Function")
    , be ("is", SLV_Prim SLPrim_is, Just "Function")
    , be ("wait", SLV_Form SLForm_wait, Just "Function")
    , be ("race", SLV_Prim SLPrim_race, Just "Function")
    , be ("fork", SLV_Form SLForm_fork, Just "Function")
    , be ("parallelReduce", SLV_Form SLForm_parallel_reduce, Just "Function")
    , be ("parallel_reduce", SLV_Deprecated (D_SnakeToCamelCase "parallel_reduce") $ SLV_Form SLForm_parallel_reduce, Just "Function")
    , be ("Map", SLV_Prim SLPrim_Map, Just "TypeParameter")
    , be ("Anybody", SLV_Anybody, Just "Keyword")
    , be ("remote", SLV_Prim SLPrim_remote, Just "Function")
    , be ("Participant", SLV_Prim SLPrim_Participant, Just "Constructor")
    , be ("ParticipantClass", SLV_Prim SLPrim_ParticipantClass, Just "Constructor")
    , be ("View", SLV_Prim SLPrim_View, Just "Constructor")
    , be ("API", SLV_Prim SLPrim_API, Just "Constructor")
    , be ("Events", SLV_Prim SLPrim_Event, Just "Constructor")
    , be ("init", SLV_Prim SLPrim_init, Just "Function")
    , be ("deploy", SLV_Deprecated (D_Replaced "deploy" "init") $ SLV_Prim SLPrim_init, Just "Function")
    , be ("setOptions", SLV_Prim SLPrim_setOptions, Just "Function")
    , be (".adaptReachAppTupleArgs", SLV_Prim SLPrim_adaptReachAppTupleArgs, Nothing)
    , be ("muldiv", SLV_Prim $ SLPrim_op MUL_DIV, Just "Function")
    , be ("verifyMuldiv", SLV_Prim $ SLPrim_verifyMuldiv, Just "Function")
    , be ("unstrict", SLV_Prim $ SLPrim_unstrict, Just "Function")
    , be ("getContract", SLV_Prim $ SLPrim_getContract, Just "Function")
    , be ("getAddress", SLV_Prim $ SLPrim_getAddress, Just "Function")
    , be (".emitLog", SLV_Prim $ SLPrim_EmitLog, Nothing)
    , be ("call", SLV_Form $ SLForm_apiCall, Just "Function")
    , be (".setApiDetails", SLV_Form $ SLForm_setApiDetails, Nothing)
    , be ("getUntrackedFunds", SLV_Prim $ SLPrim_getUntrackedFunds, Just "Function")
    , be ("fromSome", SLV_Prim $ SLPrim_fromSome, Just "Function")
    , be ( "Reach"
    ...
    ] where be (name, val, completionKind) = BaseEnvElem name val completionKind

base_env :: SLEnv
base_env =
  m_fromList_public_builtin $
    (map (\e -> (baseEnvName e, baseEnvVal e)) base_env_elems)
